...
| POST   | 新建题目       |                              | `{'bid':bid,'qname':qname,'point':[pid...],'page':page,'place':place}` | string    | qid                                                                                                  | 返回当前题目id，pid指知识点id                                                                        |
| PUT    | 修改题目       | /qid                         | `{'bid':bid,'qname':qname,'point':[pid...],'page':page,'place':place}` | undefined |                                                                                                      |                                                                                           |
